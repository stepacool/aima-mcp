...
async function decrypt$1(enc, cek, ciphertext, iv, tag2, aad) {
...
class FlattenedEncrypt {
  ...
  async encrypt(key, options) {
    ...
    const { ciphertext, tag: tag2, iv } = await encrypt(enc, this.#plaintext, cek, this.#iv, additionalData);
    const jwe = {
...
export {
  ...
  SignJWT as S,
  jwtDecrypt as a,
  decodeProtectedHeader as b,
  calculateJwkThumbprint as c,
  decodeJwt as d,
  encode as e,
  createRemoteJWKSet as f,
  importJWK as i,
  jwtVerify as j
};
