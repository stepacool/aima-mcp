...
function requireHelper() {
  ...
  hasRequiredHelper = 1;
  (function(module) {
    var path = path__default, Stream = require$$5.Stream, split = /* @__PURE__ */ requireSplit2(), util = require$$0, defaultPort = 5432, isWin = process.platform === "win32", warnStream = process.stderr;
...
function requireLib() {
  ...
  hasRequiredLib = 1;
  var fs = require$$0$1, helper2 = /* @__PURE__ */ requireHelper();
