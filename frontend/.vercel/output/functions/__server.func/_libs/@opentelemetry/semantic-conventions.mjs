...
const SemanticAttributes = /* @__PURE__ */ createConstMap([
...
const DbSystemValues = /* @__PURE__ */ createConstMap([
...
const DbCassandraConsistencyLevelValues = /* @__PURE__ */ createConstMap([
...
const FaasTriggerValues = /* @__PURE__ */ createConstMap([
...
const FaasDocumentOperationValues = /* @__PURE__ */ createConstMap([
...
const FaasInvokedProviderValues = /* @__PURE__ */ createConstMap([
...
const NetTransportValues = /* @__PURE__ */ createConstMap([
...
const NetHostConnectionTypeValues = /* @__PURE__ */ createConstMap([
...
const NetHostConnectionSubtypeValues = /* @__PURE__ */ createConstMap([
...
const MessagingDestinationKindValues = /* @__PURE__ */ createConstMap([
...
const MessagingOperationValues = /* @__PURE__ */ createConstMap([
...
const MessageTypeValues = /* @__PURE__ */ createConstMap([
...
export {
  ATTR_TELEMETRY_SDK_VERSION as A,
  SEMATTRS_DB_SYSTEM as B,
  SEMATTRS_RPC_SERVICE as C,
  SEMATTRS_MESSAGING_SYSTEM as D,
  SEMATTRS_FAAS_TRIGGER as E,
  SEMATTRS_HTTP_URL as F,
  ATTR_URL_FULL as G,
  SEMATTRS_DB_STATEMENT as H,
  SEMATTRS_HTTP_TARGET as I,
  SEMATTRS_RPC_GRPC_STATUS_CODE as J,
  SEMATTRS_HTTP_ROUTE as S,
  TELEMETRY_SDK_LANGUAGE_VALUE_NODEJS as T,
  ATTR_TELEMETRY_SDK_LANGUAGE as a,
  ATTR_TELEMETRY_SDK_NAME as b,
  ATTR_SERVICE_NAME as c,
  ATTR_EXCEPTION_TYPE as d,
  ATTR_EXCEPTION_MESSAGE as e,
  ATTR_EXCEPTION_STACKTRACE as f,
  ATTR_HTTP_ROUTE as g,
  ATTR_HTTP_REQUEST_METHOD as h,
  ATTR_HTTP_RESPONSE_STATUS_CODE as i,
  ATTR_DB_NAMESPACE as j,
  ATTR_SERVER_ADDRESS as k,
  ATTR_SERVER_PORT as l,
  ATTR_DB_OPERATION_NAME as m,
  ATTR_DB_QUERY_TEXT as n,
  ATTR_DB_SYSTEM_NAME as o,
  ATTR_DB_RESPONSE_STATUS_CODE as p,
  ATTR_ERROR_TYPE as q,
  require$$5 as r,
  ATTR_DB_COLLECTION_NAME as s,
  ATTR_SERVICE_VERSION as t,
  SEMRESATTRS_SERVICE_NAMESPACE as u,
  SEMATTRS_NET_HOST_IP as v,
  SEMATTRS_NET_HOST_PORT as w,
  SEMATTRS_NET_PEER_IP as x,
  SEMATTRS_HTTP_STATUS_CODE as y,
  SEMATTRS_HTTP_METHOD as z
};
