...
description: How to use our MCP Generator to build a server with examples and detailed explanation.
---
...
## Step 3: Runtime Values & Database Credentials
...
- A **server URL**
- An auto-generated **API key** for Bearer token authentication
- Environment status and logs

Your server supports two authentication methods:
- **Bearer Token**: Use the auto-generated API key for simple integrations
- **OAuth 2.1**: Full OAuth flow with PKCE for apps like Claude Desktop
