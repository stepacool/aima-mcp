...
Revision ID: e66ff071b846
Revises:
Create Date: 2026-01-19 02:51:42.787172
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_apikey_customer_id"), "apikey", ["customer_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_mcp_servers_customer_id"), "mcp_servers", ["customer_id"], unique=False
    )
    op.create_table(
        "chat_sessions",
    ...
    op.create_index(
        op.f("ix_chat_sessions_server_id"), "chat_sessions", ["server_id"], unique=False
    )
    op.create_table(
        "deployments",
        sa.Column("server_id", sa.UUID(), nullable=False),
        ...
        sa.Column(
            "target_config", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_deployments_server_id"), "deployments", ["server_id"], unique=True
    )
    op.create_table(
        "mcp_prompts",
        sa.Column("server_id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_mcp_prompts_server_id"), "mcp_prompts", ["server_id"], unique=False
    )
    op.create_table(
        "mcp_tools",
        sa.Column("server_id", sa.UUID(), nullable=False),
        ...
        sa.Column("description", sa.Text(), nullable=False),
        sa.Column(
            "parameters_schema", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_mcp_tools_server_id"), "mcp_tools", ["server_id"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_deployment_artifacts_deployment_id"),
        "deployment_artifacts",
        ["deployment_id"],
        unique=True,
    )
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_deployment_artifacts_deployment_id"), table_name="deployment_artifacts"
    )
