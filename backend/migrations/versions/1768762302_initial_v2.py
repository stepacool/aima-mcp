...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_deployments_server_id'), 'deployments', ['server_id'], unique=True)
    ...
    op.create_index(op.f('ix_deployment_artifacts_deployment_id'), 'deployment_artifacts', ['deployment_id'], unique=True)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_deployment_artifacts_deployment_id'), table_name='deployment_artifacts')
