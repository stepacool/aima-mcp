...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_mcp_environment_variables_server_id"),
        "mcp_environment_variables",
        ["server_id"],
        unique=False,
    )
    ...
    op.create_foreign_key(
        None, "apikey", "mcp_servers", ["server_id"], ["id"], ondelete="CASCADE"
    )
...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["server_id"],
            ["mcp_servers.id"],
            name=op.f("chat_sessions_server_id_fkey"),
            ondelete="CASCADE",
        ),
    ...
    op.drop_index(
        op.f("ix_mcp_environment_variables_server_id"),
        table_name="mcp_environment_variables",
    )
